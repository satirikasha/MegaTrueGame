...
public class CameraArm : MonoBehaviour {
    ...
    private Vector3 GetFocusPosition() {
        ...
        if (count > 0) {
            return offset + PlayerController.LocalPlayer.transform.position - Vector3.forward * Distance;
        }
        else {
            return PlayerController.LocalPlayer.transform.position - Vector3.forward * Distance;
        }
    }
